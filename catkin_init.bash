...
if [[ ! -d ".catkin_tools" ]]; then
    catkin init
    catkin config --profile $build_type --cmake-args -DCMAKE_CXX_STANDARD=${cxx_standard} -DCMAKE_BUILD_TYPE=${build_type^} -DCMAKE_EXPORT_COMPILE_COMMANDS=1 -DCMAKE_CXX_COMPILER_LAUNCHER=ccache
