...
int main(int argc, char** argv)
{
  ...
  std::cout << "Start call view_point_extractor_server service...\n";
  ...
  while(true)
  {
    ...
    {
      std::cout << "call view_point_extractor_server failed!\n";

      return -1;
    }

    std::cout << "Get view_point_extractor_server response!\n";
  }
  return 0;
}
